...
@section('title')
<title>Danh sách tìm kiếm danh mục</title>
@stop
@section('search')
...
<div class="col-xs-12">
	...
	<div class="table-header">
		Bảng danh sách danh mục tìm kiếm
				...
				<tr>
					...
					<td>
						<div class=" action-buttons">
							<a class="blue" href="{{route('page_update_category',[$category->id])}}" title="Cập nhật">
								<i class="ace-icon fa fa-pencil bigger-130"></i>
							</a>
							<a class="red" href="{{route('page_del_category',[$category->id])}}" title="Xóa" onclick="return confirm('bạn có muốn xóa danh mục {{$category->name}}?');">
