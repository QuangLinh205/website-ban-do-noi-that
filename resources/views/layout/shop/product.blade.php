...
<section class="bg0 p-t-23 p-b-140">
	<div class="container">
		<div class="p-b-10">
			<h1 class="l5 hov1 bor3 trans-04 m-r-32 m-tb-5">
				Trang sản phẩm
			</h1>
		</div>
		...
		<div class="flex-w flex-sb-m p-b-52">
			<div class="flex-w flex-l-m filter-tope-group m-tb-10">
				<button class="cl5 bor3 m-r-32" data-filter="*">
					Tất cả sản phẩm
				</button>
				@foreach($cat as $ca)
				<button class="cl5 bor3 m-r-32 " data-filter=".{{$ca->id}}">
					{{$ca->name}}
				</button>
				@endforeach
			</div>
		...
		<div class="row isotope-grid">
			@foreach($pro as $pr)
			<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item {{$pr->id_category}}">
				<!-- Block2 -->
				<div class="block2">
					<div class="block2-pic hov-img0">
						<img src="{{url('')}}/uploads/{{$pr->image}}" alt="IMG-PRODUCT">
